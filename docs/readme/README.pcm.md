...
1. [Download the Universal version for macOS from GitHub Releases.](https://github.com/ChineseMao/SlimLuma/releases/download/v0.2.1/SlimLuma-0.2.1-macOS-universal.dmg)
